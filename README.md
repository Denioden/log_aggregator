...
## Работа с cron:
### Настройка cron.
    - переходим в settings.py
    - настраиваем __CRONJOBS__
    ...
    ```
    - По умолчанию запуск программы настроен каждую минуту.
...
#### Примеры:
- '*/1 * * * *' Запуск программы каждую минуту.

- '* */1 * * *' Запуск программы каждый час.

- '* * */1 * *' Запуск программы каждый день.

- '* * * */1 *' Запуск программы каждый месяц.

- '* * * * */1' Запуск программы в определённый день недели.

#### Редактор выражений расписания cron: https://crontab.guru/
